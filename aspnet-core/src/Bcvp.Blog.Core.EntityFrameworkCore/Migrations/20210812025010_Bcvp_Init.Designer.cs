...
namespace Bcvp.Blog.Core.Migrations
{
    ...
    [Migration("20210812025010_Bcvp_Init")]
    partial class Bcvp_Init
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bcvp.Blog.Core.BlogCore.Blogs.Blog", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Bcvp.Blog.Core.BlogCore.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Bcvp.Blog.Core.BlogCore.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Bcvp.Blog.Core.BlogCore.Tagging.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Bcvp.Blog.Core.BlogCore.Comments.Comment", b =>
                {
                    b.HasOne("Bcvp.Blog.Core.BlogCore.Posts.Post", null)
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Bcvp.Blog.Core.BlogCore.Comments.Comment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Bcvp.Blog.Core.BlogCore.Posts.Post", b =>
                {
                    b.HasOne("Bcvp.Blog.Core.BlogCore.Blogs.Blog", null)
                        .WithMany()
                        .HasForeignKey("BlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("Bcvp.Blog.Core.BlogCore.Posts.PostTag", "Tags", b1 =>
                        {
